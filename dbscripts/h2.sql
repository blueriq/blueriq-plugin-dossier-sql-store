...
CREATE TABLE aq_dossier 
  ( 
     ...
     CONSTRAINT pk_aq_dossier PRIMARY KEY (id) 
  ); 
...
CREATE TABLE dossier_releases 
  ( 
     ...
     CONSTRAINT pk_dossier_releases PRIMARY KEY (id) 
  ); 

/** 
 * Create sequences 
 */
CREATE SEQUENCE s_dossier_releaseid START WITH 1 INCREMENT BY 1 MINVALUE 0;

CREATE SEQUENCE hibernate_sequence START WITH 1 INCREMENT BY 1 MINVALUE 0;
